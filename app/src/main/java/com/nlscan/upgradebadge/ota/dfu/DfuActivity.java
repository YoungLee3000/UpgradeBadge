package com.nlscan.upgradebadge.ota.dfu;
...
import com.nlscan.upgradebadge.ota.FileHelper;
import com.nlscan.upgradebadge.ota.PermissionRationaleFragment;
...
import com.nlscan.upgradebadge.R;
import com.nlscan.upgradebadge.ota.scanner.ScannerFragment;
...
public class DfuActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>,
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        mDfuAddress = getIntent().getStringExtra("ADDRESS");
        if (filepath != null){
    ...
    private void setGUI() {
        ...
        getSupportActionBar().setTitle(R.string.dfu_feature_title);
        ...
        mScrollView = findViewById(R.id.dfu_scrollView);
    ...
    private void showDeviceScanningDialog() {
        ...
        scannerFragment = new ScannerFragment(null, mDfuAddress);
        scannerFragment.onAttach(this);
    }
    ...
    public void onDeviceSelected(final BluetoothDevice device, final String name) {
        Log.i(TAG,"onDeviceSelected: "+name);
        mSelectedDevice = device;
        mUploadButton.setEnabled(mStatusOk);
        mDeviceNameView.setText(name != null ? name : getString(R.string.not_available));
        mScrollView.smoothScrollTo(0, 960);
    ...
    private void onTransferCompleted() {
        ...
        mFileStatusView.setText("");
        mUploadButton.setEnabled(true);
        mUploadButton.setOnClickListener(null);
        mUploadButton.setText(R.string.dfu_success);
    }
